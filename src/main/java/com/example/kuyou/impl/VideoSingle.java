...
@Repository
@ComponentScan
public class VideoSingle implements VideoInfo {

    private JdbcOperations jdbcOperations;

    private static final String SELECT_VIDEO_SINGLE =
            "select v_id, v_cover, v_content, v_creator, v_date, " +
                    ...
                    "where video.v_id = ? and view.view_id = video.view_id " +
                    "and music.m_id = video.m_id;";

    @Autowired
    public VideoSingle(JdbcOperations jdbcOperations){
    ...
    public List<Video> getVideoInfo(long id) {
        ...
        return jdbcOperations.query(SELECT_VIDEO_SINGLE,rowMapper, new Object[]{id});
    }
